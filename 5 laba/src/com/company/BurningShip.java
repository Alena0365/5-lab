...
public class BurningShip extends FractalGenerator
{
     ...
     * начального диапазона для фрактала. Устанавливает x=-2, y=-2.5, а их ширину и высоту равными 4.
     */
    ...
    /**
     * данный метод реализует итеративную функцию для фрактала BurningShip.
